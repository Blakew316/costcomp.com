...
const MAX_FILES = 36;   // pages: three monthly bank statements of about 12 scanned pages
  ...
  properties: {
    ...
    bank: nullable({
      ...
      properties: {
        ...
        processing_fees: bankGroup("Fees the card processor debits (discount, monthly, statement, PCI, processor chargeback fees), however terse the memo: 'Orig CO Name:Bankcard … Descr:Mthly Fees', 'BANKCARD 8076 MTOT DISC', 'MERCH FEE'. A debit from the same company that sends the card deposits is a processing fee."),
        ...
        mca_funding: bankGroup("Cash advance or business loan proceeds received, including a processor's capital program paying out (for example '360 PAYMENTS CAP', 'Square Capital') — never card sales."),
